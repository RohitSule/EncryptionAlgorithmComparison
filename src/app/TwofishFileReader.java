...
class TwofishFileReader extends Thread {
    int counter = 0;
    static long time_second = 0;

    public static void main(String[] args) throws Exception {
        /* 
        * Generating a Secrect key which is used for encryption and decryption of File data by using Twofish.  
        */
        File file_obj = new File("D:/Cantbry/sum");
    ...
    public static byte[][] cbcEncrypt(SecretKey key, byte[] data) throws GeneralSecurityException {
        Thread u = new TwofishFileReader();
        u.start();

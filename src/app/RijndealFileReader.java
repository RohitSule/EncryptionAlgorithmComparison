...
class RijndaelFilerReader extends Thread 
{
    int counter = 0;
    ...
    {
        /* 
        * Generating a Secrect key which is used for encryption and decryption of File data by using Rijndeal.  
        */
        File file_obj = new File("D:/Cantbry/grammar.lsp");
    ...
    public static byte[][] cbcEncrypt(SecretKey key, byte[] data) throws GeneralSecurityException {  
        Thread u = new RijndaelFilerReader();
        u.start();
